...
mysql_select_db("veritabani_central");
						...
						if(!empty($Padi) && !empty($kripto)) {
							...
							$sorgu=mysql_query("SELECT kul_adi,kul_sifre FROM panel_kul where kul_adi ='$Padi' and kul_sifre='$kripto' and kul_yetki='0' ");
							$verisay=mysql_num_rows($sorgu);
							if($verisay !=0 ){
								$_SESSION['yadi']=$Padi;
								echo "başarılı şekilde giriş yaptınız";
								echo $_SESSION['yadi'];
								header("Location: ./bankaci/index.php");
								            }
													       }
							else
							{
...
<html>
    ...
    <body>
		<div class="wrapper">
	    <h1>Central Bank</h1>
			<h2><span>Calisan Paneli</span></h2>
			<div class="content">
