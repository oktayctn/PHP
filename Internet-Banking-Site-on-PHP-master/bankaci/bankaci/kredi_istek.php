...
//kredi_istek tablosuna veri girişi

@$istek1=$_POST['sil1'];
@$istek2=$_POST['kaydet1'];
...
$sorgu=mysql_query("SELECT kredi_istek.miktar,uyeler_adi.tckimlik, uyeler_adi.hesapbilgi
FROM kredi_istek
INNER JOIN uyeler_adi ON kredi_istek.tckimlik = uyeler_adi.tckimlik ");
									...
									if(isset($istek1) && isset($istek2) )
									{
										include("ekle_uyari.php");
										
									
									}
									else if(!isset($istek1)&& !isset($istek2)) 
									{
										include("ekle_uyari.php");
									...
									else if(isset($istek1)&& !isset($istek2)) 
									{
										...
										mysql_query("TRUNCATE TABLE kredi_istek");
									
									}
									else if(!isset($istek1)&& isset($istek2)) 
									{
										while($veri1=mysql_fetch_array($sorgu)){
										
										$nakit_son= $veri1['miktar']+$veri1['hesapbilgi'];
										$tckimlik=$veri1['tckimlik'];
										
										mysql_query("UPDATE uyeler_adi  SET hesapbilgi='$nakit_son' where tckimlik='$tckimlik'");
									    mysql_query("TRUNCATE TABLE kredi_istek");
																				}
									}
...
//---kredi_istek tablosuna ver girişi
            ...
            <div class="row">
                <div class="col-md-12">	
                            <div class="panel panel-primary"> 
                             ...
                             <form name="form" method="post" action="kredi_istek.php">
                                  <input type="checkbox" name="sil1" id="Sil1">
                                  <label for="kontrol">Sil</label>
                                  
                                    <input type="checkbox" name="kaydet1" id="Kaydet1">
