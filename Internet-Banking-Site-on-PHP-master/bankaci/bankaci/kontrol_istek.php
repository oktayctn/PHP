...
if(isset($_POST['sil'])) {
    $silinecekler = implode(', ', $_POST['sil']);
  	//echo "<br><br><br><br><br><br>".$silinecekler."<br>";
    mysql_query('DELETE FROM kredi_istek WHERE id_kredi IN ( ' . $silinecekler . ' )');
    echo count($_POST['sil']) . ' adet istek silindi.';//uygulama ön planında gözükmüyor. yönetim paneli div i altında kalıyor. görmek
	//istiyorsan başına <br> tagı ekle
}
