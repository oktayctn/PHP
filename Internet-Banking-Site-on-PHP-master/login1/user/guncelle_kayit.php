...
//post verileri güncellenmek için alındı....
$tel=ltrim($_POST['tel']);
$mail=ltrim($_POST['mail']);
$yas=ltrim($_POST['yas']);
$adres=ltrim($_POST['adres']);
//----post verileri güncellenmek için alındı....
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <!-- <a   class="active-menu" href="bireysel.php"><i class="fa fa-dashboard fa-3x"></i> Anasayfa</a> -->
 ...
 <div class="row">
                ...
                <form class="form-horizontal" role="form" method="post" action="guncelle_kayit.php">
                  <?php  
							...
							$sorgu=mysql_query("UPDATE uye_bilgi set adres='$adres',yas='$yas',tel='$tel',mail='$mail' where tckimlik='$tckimlik'");	
							if($sorgu)
							{
                ...
                <div class="form-group">
        		 <label for="email" class="col-sm-2 control-label">Telefon:</label>
       				    <div class="col-sm-9">
            	 <input type="text" class="form-control" id="bankano" name="tel" placeholder="" value="<?php echo $tel;?>">
       			 </div>
    				</div>
                ...
                <div class="form-group">
        		 <label for="email" class="col-sm-2 control-label">Mail:</label>
       				    <div class="col-sm-9">
            	 <input type="text" class="form-control" id="tckimlik" name="mail" placeholder="" value="<?php echo $mail;?>">
       			 </div>
    				</div>
      			  ...
      			  <label for="name" class="col-sm-2 control-label">Yaş</label>
      				  <div class="col-sm-9">
       		     <input type="text" class="form-control" id="isim" name="yas" placeholder="" value="<?php echo $yas;?>">
       				  </div>
    			</div>  
      			  ...
      			  <label for="message" class="col-sm-2 control-label">Adres</label>
       				 <div class="col-sm-9">
          		  <textarea class="form-control" rows="4" name="adres" ><?php echo $adres?></textarea>
       				 </div>
    				</div>
